...
- Imagens externas: thumbnails públicas do YouTube usadas apenas por URL, sem arquivos de imagem no repositório.
...
- Imagens oficiais/autorizadas do canal, se houver permissão de uso.
