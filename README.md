...
- Imagens anexadas pelo usuário: embutidas diretamente no `index.html` como data URIs textuais, evitando arquivos binários no PR e garantindo renderização no GitHub Pages.
